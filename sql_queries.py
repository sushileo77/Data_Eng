...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplays (songplay_id varchar, start_time bigint, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id varchar, location varchar, user_agent varchar);"
...
song_select = ("SELECT songs.title, artists.artist_name FROM songs JOIN artists ON songs.artist_id = artists.artist_id")
