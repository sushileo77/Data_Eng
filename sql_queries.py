...
song_select = ("SELECT songs.title, artists.artist_name FROM songs JOIN artists ON songs.artist_id = artists.artist_id WHERE songs.title = (%s) AND artists.artist_name = (%s) AND songs.duration = (%s)")
